<%-- 
    Document   : index
    Created on : Jan 9, 2018, 6:15:08 PM
    Author     : xen
--%>
...
<html>
	...
	<div id="header">
			...
			<tr><td><div><marquee direction="up" width="300px" truespeed="truespeed" onmouseover="stop()" onmouseout="start()" style="color: red;">Last Date of fee Submission is 15/2/18
